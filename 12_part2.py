...
if __name__ == '__main__':
    ...
    for src in tqdm(src_list):
        ...
        #print(len(shortest))
        if overall_shortest > len(shortest):
            overall_shortest = len(shortest)

    print(f"Overall shortest: {overall_shortest}")